...
class _InscriptionPageWidgetState extends State<InscriptionPageWidget>
  ...
  void _toggleMerchantTermsAcceptance() {
    safeSetState(() {
      _model.checkboxCommercantValue =
          !(_model.checkboxCommercantValue ?? false);
    });
  }
                ...
                Expanded(
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      final tabContentHeight = constraints.maxHeight > 560.0
                          ? 560.0
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  _persistReferralCodeInput(
                                                                    _model.referralCodeJoueurTextController
                                                                            ?.text ??
                                                                        '',
                                                                  );
                                              ...
                                              Form(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    if (_showProfessionalCategoryField)
                                                      Padding(
                                                        padding:
                                                            const EdgeInsetsDirectional
                                                                .fromSTEB(0.0,
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            ...
                                                            _persistReferralCodeInput(
                                                              _model.referralCodeCommercantTextController
                                                                      ?.text ??
                                                                  '',
                                                            );

                                                            safeSetState(() {
                                                              _isSubmittingMerchantSignup =
                                                                  true;
                                                            });
                                                            try {
                                                              debugPrint(
  ...
  String _normalizedReferralCode(String? value) =>
