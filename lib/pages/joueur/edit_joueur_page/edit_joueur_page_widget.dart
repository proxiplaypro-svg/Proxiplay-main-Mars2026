...
class EditJoueurPageWidget extends StatefulWidget {
  ...
  static String routeName = 'EditJoueurPage';
  static String routePath = 'editJoueurPage';

  @override
  State<EditJoueurPageWidget> createState() => _EditJoueurPageWidgetState();
}

class _EditJoueurPageWidgetState extends State<EditJoueurPageWidget> {
  late EditJoueurPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditJoueurPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'EditJoueurPage'});
