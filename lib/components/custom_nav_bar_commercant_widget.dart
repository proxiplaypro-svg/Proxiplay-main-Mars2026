...
class CustomNavBarCommercantWidget extends StatefulWidget {
  const CustomNavBarCommercantWidget({
    super.key,
    this.indexActive,
  });
  ...
  @override
  State<CustomNavBarCommercantWidget> createState() =>
      _CustomNavBarCommercantWidgetState();
}

class _CustomNavBarCommercantWidgetState
    extends State<CustomNavBarCommercantWidget> {
  late CustomNavBarCommercantModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomNavBarCommercantModel());
