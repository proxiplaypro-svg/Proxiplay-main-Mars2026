...
class _HomeJoueurPageWidgetState extends State<HomeJoueurPageWidget>
  ...
  Widget _buildHomeGameCard({
    ...
    String? winnerText,
    String? badgeText,
    String finishedInfoText = 'Jeu terminÃ©',
      ...
      case 'specialCampaign':
        return SharePromoData(
          ...
          subtitle: state.message ??
              'Aide un ami Ã  dÃ©couvrir Proxiplay et joue Ã  tous les jeux jusquâ€™Ã  minuit.',
  ...
  String _buildRecentWinnerMessage(PrizesRecord prize, UsersRecord user) {
    ...
    return '$firstName a gagnÃ© $prizeName chez $enseigneName';
  }
          ...
          return const Padding(
            ...
            child: SharePromoBanner(
              data: SharePromoData(
                ...
                subtitle: 'Tu peux jouer Ã  tous les jeux jusquâ€™Ã  minuit.',
    ...
    final referralCodeText =
        normalizedReferralCode == null || normalizedReferralCode.isEmpty
            ...
            : '\n\nCode parrainage : $normalizedReferralCode\n\n'
                'Si le code ne se remplit pas automatiquement aprÃ¨s installation, '
                'entre-le manuellement Ã  lâ€™inscription.';
    final templates = <String>[
      'ðŸŽ® Inscris-toi avec mon lien sur ProxiPlay !\n'
          'TÃ©lÃ©charge lâ€™app ici :\n'
          '$shareLink'
          '$referralCodeText\n\n'
          'Si tu rejoins lâ€™app, je dÃ©bloque lâ€™accÃ¨s Ã  tous les jeux jusquâ€™Ã  minuit ðŸ‘‡',
      'ðŸŽ¯ Viens tester ProxiPlay avec mon invitation !\n'
          'TÃ©lÃ©charge lâ€™app ici :\n'
          '$shareLink'
          '$referralCodeText\n\n'
          'Si tu tâ€™inscris, je joue Ã  tous les jeux jusquâ€™Ã  minuit ðŸ‘‡',
      'ðŸ”¥ Rejoins-moi sur ProxiPlay !\n\n'
          'TÃ©lÃ©charge lâ€™app ici :\n'
          '$shareLink'
          '$referralCodeText\n\n'
          'Ton inscription avec mon code me dÃ©bloque lâ€™accÃ¨s Ã  tous les jeux jusquâ€™Ã  minuit ðŸ‘‡',
      'ðŸŽ Jâ€™ai une invitation ProxiPlay pour toi !\n'
          'TÃ©lÃ©charge lâ€™app ici :\n'
          '$shareLink'
          '$referralCodeText\n\n'
          'Si tu tâ€™inscris avec mon lien, je dÃ©bloque tous les jeux jusquâ€™Ã  minuit ðŸ‘‡',
      'ðŸš€ Tu peux tester ProxiPlay avec mon lien !\n'
          'TÃ©lÃ©charge lâ€™app ici :\n'
          '$shareLink'
          '$referralCodeText\n\n'
          'Si tu rejoins lâ€™app, jâ€™obtiens lâ€™accÃ¨s Ã  tous les jeux jusquâ€™Ã  minuit ðŸ‘‡',
      'ðŸŽ® Clique sur mon lien pour dÃ©couvrir ProxiPlay !\n'
          'TÃ©lÃ©charge lâ€™app ici :\n'
          '$shareLink'
          '$referralCodeText\n\n'
          'Si tu tâ€™inscris, je dÃ©bloque lâ€™accÃ¨s Ã  tous les jeux jusquâ€™Ã  minuit ðŸ‘‡',
    ];
                                                                        ...
                                                                        itemBuilder:
                                                                          ...
                                                                          return _buildHomeGameCard(
                                                                            ...
                                                                            enseigne:
                                                                                enseigne,
                                                                            prizeText:
                                                                                listViewGamesRecord.prizeValue == 0 ? 'Gains instantanÃ©s' : '${listViewGamesRecord.prizeValue} \u20AC',
                                                                            endDateText: listViewGamesRecord.endDate != null
                                                                                ? "Jusqu'au : ${dateTimeFormat('d/M/y', listViewGamesRecord.endDate, locale: FFLocalizations.of(context).languageCode)}"
                                                                                : "Jusqu'au : -",
                                                                            onTap:
